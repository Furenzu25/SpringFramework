...
public class Example7 {
    ...
    if(volksVehicle != null){
        System.out.println("Programming Vehicle from Spring Context is: "+ volksVehicle.getName());
    }else{
        System.out.println("Programming Vehicle from Spring Context is: "+ audiVehicle.getName());
    }
    }
}
